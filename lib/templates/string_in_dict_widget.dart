...
class StringInDictWidget extends StatefulWidget {
  final double width, height;
  final String title;
  final Function setTitle, setType, getValue, setValue, onRm, isNewKeyValid;
  const StringInDictWidget({this.width, this.height, this.title, this.setTitle, this.setType, this.getValue, this.setValue, this.onRm, this.isNewKeyValid});
  @override
  _StringInDictWidgetState createState() => _StringInDictWidgetState();
}

class _StringInDictWidgetState extends State<StringInDictWidget> {
