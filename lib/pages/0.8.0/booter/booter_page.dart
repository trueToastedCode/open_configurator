        ...
        body: TabBarView(
          children: [
            Padding(
              ...
              child: SingleChildScrollView(child: BooterMmioWhitelistWidget()),
            ),
            Padding(
              padding: EdgeInsets.only(left: globals.INNER_PADDING),
              child: SingleChildScrollView(child: BooterPatchWidget()),
            ),
            Padding(
              padding: EdgeInsets.only(left: globals.INNER_PADDING),
              child: SingleChildScrollView(child: BooterQuirksWidget()),
            ),
          ],
        ),
      ),
