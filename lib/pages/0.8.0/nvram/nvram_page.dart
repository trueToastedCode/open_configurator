...
import 'package:open_configurator/pages/0.8.0/nvram/nvram_legacy_schema_widget.dart';
import 'package:open_configurator/pages/0.8.0/nvram/nvram_legacy_widget.dart';
        ...
        body: TabBarView(
          children: [
            Padding(
              ...
              child: SingleChildScrollView(child: NvramAddWidget()),
            ),
            Padding(
              padding: EdgeInsets.only(left: globals.INNER_PADDING),
              child: SingleChildScrollView(child: NvramDeleteWidget()),
            ),
            Padding(
              padding: EdgeInsets.only(left: globals.INNER_PADDING),
              child: SingleChildScrollView(child: NvramLegacyWidget()),
            ),
            Padding(
              padding: EdgeInsets.only(left: globals.INNER_PADDING),
              child: SingleChildScrollView(child: LegacySchemaWidget()),
            ),
          ],
        ),
      ),
