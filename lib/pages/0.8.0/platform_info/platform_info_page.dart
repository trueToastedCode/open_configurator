...
import 'package:open_configurator/pages/0.8.0/platform_info/platform_info_generic_widget.dart';
import 'package:open_configurator/pages/0.8.0/platform_info/platform_info_main_widget.dart';
        ...
        body: TabBarView(
          children: [
            Padding(
              ...
              child: SingleChildScrollView(child: PlatformInfoGenericWidget()),
            ),
            Padding(
              padding: const EdgeInsets.only(left: globals.INNER_PADDING),
              child: SingleChildScrollView(child: PlatformInfoMainWidget()),
            ),
          ],
        ),
      ),
